...
INSERT INTO `meeting` (`id`, `service`, `type`, `title`, `fname`, `lname`, `time`) VALUES
(1, 'housing', 'citizen', 'Mr.', 'Aydan', 'Aleydin', '2016-10-24 01:50:30');
...
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, NULL, 1268889823, 1477276699, 1, 'Admin', 'istrator', 'ADMIN', '0');
